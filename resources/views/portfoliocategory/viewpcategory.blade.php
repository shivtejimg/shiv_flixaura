    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                  <a class="btn btn-primary" href="{{route('category.createpcategory')}}">
                    ...
                    <tbody>
                        @forelse ($collection as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('category.editpcategory',$item->id)}}" type="button"
                                        class="btn btn-success btn-sm">
                                        <i class="bi-pencil-fill me-1"></i> Edit
                                    </a>
                                    <a href="{{route('category.delepcategory',$item->id)}}" type="button"
                                        class="btn btn-danger btn-sm">
                                        <i class="bi-trash-fill me-1"></i> Delete
                                    </a>
                                    @if($item->status==0)
                                        <a href="{{route('category.enbdisbpcategory',$item->id)}}" type="button"
                                            class="btn btn-danger btn-sm">
                                            Enable
                                        </a>
                                    @else
