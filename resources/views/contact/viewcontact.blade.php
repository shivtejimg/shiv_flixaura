        ...
        <div class="card">
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <h4 class="card-header-title">View Contacts</h4>
                </div>
                <div class="mb-2 mb-md-0">
                    <form>
                        <!-- Search -->
                    ...
                    <tbody>
                        @forelse ($collection as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('contact.deletecontactus', $item->id) }}" type="button"
                                        class="btn btn-danger btn-sm">
                                        <i class="bi-trash-fill me-1"></i> Delete
                                    </a>
                                    @if($item->status==0)
                                        <a href="{{route('contact.enbdisbcontactus',$item->id)}}" type="button"
                                ...
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->subject }}</span>
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
