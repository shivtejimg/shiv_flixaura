    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h1 class="page-header-title">Carrier Manager</h1>
                </div>
            </div>
            <!-- End Row -->
        </div>
        ...
        <div class="card">
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <h4 class="card-header-title">View Carrier Requests</h4>
                </div>
                <div class="mb-2 mb-md-0">
                    <form>
                        <!-- Search -->
                    ...
                    <tbody>
                        @forelse ($collection as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('carrier.deletecarrier', $item->id) }}" type="button"
                                        class="btn btn-danger btn-sm">
                                        <i class="bi-trash-fill me-1"></i> Delete
                                    </a>
                                    @if($item->status==1)
                                        <a href="{{route('carrier.enbdisbcarrier',$item->id)}}" type="button"
                                ...
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->job_title }}</span>
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->bio }}</span>
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <a href="{{asset('/public/resume_file/'.$item->resumefile)}}" target="_blank" type="button"
                                            class="btn btn-success btn-sm">
                                            View
                                        </a>
                                    </div>
