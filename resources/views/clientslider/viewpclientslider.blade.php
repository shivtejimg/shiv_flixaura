    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                  <a class="btn btn-primary" href="{{route('client.createclientslider')}}">
                      <i class="bi-plus"></i> Add Slider
                  </a>
              </div>
            </div>
            <!-- End Row -->
        ...
        <div class="card">
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <h4 class="card-header-title">View Slider</h4>
                </div>
                <div class="mb-2 mb-md-0">
                    <form>
                        <!-- Search -->
                    ...
                    <tbody>
                        @forelse ($collection as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('client.deleclientslider',$item->id)}}" type="button"
                                        class="btn btn-danger btn-sm">
                                        <i class="bi-trash-fill me-1"></i> Delete
                                    </a>
                                    @if($item->status==0)
                                        <a href="{{route('client.enbdisbclientslider',$item->id)}}" type="button"
                                            class="btn btn-danger btn-sm">
                                            Enable
                                        </a>
                                    @else
                                ...
                                <td>
                                    <img class="avatar-img" src="{{ asset('public/' . $item->image) }}" height="100px"
                                        width="100px">
                                </td>
                            </tr>
                        @empty
