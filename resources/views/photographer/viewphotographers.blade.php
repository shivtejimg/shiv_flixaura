...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h1 class="page-header-title">Photographer Manager</h1>
                </div>
                <div class="col-auto">
                    <a class="btn btn-primary" href="{{ route('photographer.viewrequests') }}">
                        <i class="bi-eye"></i> Photographer Requests
                    </a>
                </div>
            </div>
            <!-- End Row -->
        ...
        <div class="card">
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <h4 class="card-header-title">View Registred Photographer</h4>
                </div>
                <div class="mb-2 mb-md-0">
                    <form>
                        <!-- Search -->
                    ...
                    <tbody>
                        @forelse ($collection as $item)
                            <tr>
                                ...
                                {{-- <td>
                                    <a href="{{ route('photographer.approverequest', $item->id) }}" type="button"
                                        class="btn btn-success btn-sm">
                                        <i class="bi bi-check-circle-fill me-1"></i> Approve
                                    </a>
                                    <a href="{{ route('photographer.rejectrequest', $item->id) }}" type="button"
                                        class="btn btn-danger btn-sm">
                                        <i class="bi-trash-fill me-1"></i> Reject
                                    </a>
                                </td> --}}
                                ...
                                <td class="table-column-ps-0">
                                    <img class="avatar-img" src="{{ $item->image}}" height="50px"
                                        width="50px">
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                ...
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->address }}</span>
                                    </div>
                                </td>
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->aadhar }}</span>
                                    </div>
                                </td>
                            </tr>
                        @empty
    ...
    <script>
        function load(id) {
            $.ajax({
                'type': 'POST',
                'url': '<?php echo asset('/my-admin/updatelocation'); ?>',
                'data': {
                    _token: "{{ csrf_token() }}",
                    id: id,
                },
