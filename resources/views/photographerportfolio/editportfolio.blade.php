    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    <a class="btn btn-primary" href="{{ route('viewphotoportfolio') }}">
            ...
            <div class="col-lg-12 mb-3 mb-lg-0">
                ...
                <div class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-header">
                        <h4 class="card-header-title">EDIT PORTFOLIO</h4>
                    </div>
                    <!-- End Header -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="tom-select-custom">
                                            <select onchange="select_type()" class="js-select form-select" id="type"
                                                name="type"
                                                data-hs-tom-select-options='{
                                                      "searchInDropdown": false,
                                                      "hideSearch": true
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="title" id="title"
                                            placeholder="Enter Title" aria-label="Enter Title" value="{{ $data->title }}">
                                    </div>
                                    <!-- End Form -->
                                </div>
