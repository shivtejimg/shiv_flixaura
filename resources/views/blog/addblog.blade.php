            ...
            <div class="col-lg-12 mb-3 mb-lg-0">
                ...
                <div class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-header">
                        <h4 class="card-header-title">Add Blog</h4>
                    </div>
                    <!-- End Header -->
                    ...
                    <form method="POST" action="#" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4 mb-lg-5">
                                ...
                                <input type="file" name="image" id="customFileEg1" class="form-control" required>
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" name="meta_description"
                                    id="categoryNameLabel" placeholder="" aria-label="" value="" required>
                            </div>
                            <!-- End Form -->
