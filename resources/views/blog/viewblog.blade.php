    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h1 class="page-header-title">Blog Manager</h1>
                </div>
                <div class="col-auto">
                    <a class="btn btn-primary" href="{{ route('blog.index') }}">
                        <i class="bi-eye"></i> Add Blog
                    </a>
                </div>
            </div>
            <!-- End Row -->
        ...
        <div class="card">
          ...
          <div class="card-header card-header-content-md-between">
              <div class="mb-2 mb-md-0">
                  <h4 class="card-header-title">View Blog</h4>
              </div>
              <div class="mb-2 mb-md-0">
                  <form>
                      <!-- Search -->
              ...
              <table id="datatable"
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                          <a href="{{ route('blog.edit', $item->id) }}" type="button" class="btn btn-white btn-sm">
                            <i class="bi-pencil-fill me-1"></i> Edit
                          </a>
                          <a href="{{ route('blog.delete', $item->id) }}" type="button" class="btn btn-white btn-sm">
                      ...
                      @if(isset($url['scheme']))
                      <td class="email"><img class="avatar-img" src="{{$item->image}}" height="50px" width="50px"></td>
                      @else
                      <td class="email"><img class="avatar-img" src="{{asset('public/blog/'.$item->image)}}" height="50px" width="50px"></td>
                      @endif
                      <td class="table-column-ps-0">
                          <div class="ms-3">
