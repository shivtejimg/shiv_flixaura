    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    <a class="btn btn-primary" href="{{ route('blogcategory.index') }}">
                        <i class="bi-eye"></i> Add Blog Category
                    </a>
                </div>
            </div>
            <!-- End Row -->
        ...
        <div class="card">
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <h4 class="card-header-title">View Blog Category</h4>
                </div>
                <div class="mb-2 mb-md-0">
                    <form>
                        <!-- Search -->
                    ...
                    <tbody>
                        @forelse ($collection as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('blogcategory.edit', $item->id) }}" type="button"
                                        class="btn btn-white btn-sm">
                                        <i class="bi-pencil-fill me-1"></i> Edit
                                    </a>
                                    <a href="{{ route('blogcategory.delete', $item->id) }}" type="button"
                                        class="btn btn-white btn-sm">
                                        <i class="bi-trash-fill me-1"></i> Delete
                                    </a>
                                    @if ($item->status == 0)
                                        <a href="{{ route('blogcategory.enbdiscategory', $item->id) }}" type="button"
                                ...
                                @if (isset($url['scheme']))
                                    <td class="email"><img class="avatar-img" src="{{ $item->image }}" height="50px"
                                            width="50px"></td>
                                @else
                                    <td class="email"><img class="avatar-img"
                                            src="{{ asset('public/blog/' . $item->image) }}" height="50px"
                                            width="50px"></td>
                                @endif
                                <td class="table-column-ps-0">
                                    <div class="ms-3">
                                        <span class="d-block h5 text-inherit mb-0">{{ $item->writername }}</span>
                                    </div>
                                </td>
                            </tr>
                        @empty
