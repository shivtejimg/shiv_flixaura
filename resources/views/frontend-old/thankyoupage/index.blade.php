                        ...
                        <div class="row text-sm-start text-center">
                            ...
                            <div class="col-12 mt-3">
                                <div class="hero p-0 text-sm-start text-center">
                                    <button type="button" id="formsubmit" class="comman_button shadow text-black d-inline-flex align-items-center justify-content-start mb-0"><span class="text-black">Back to Home <img src="{{ asset('/public') }}/frontend_assets/img/header/logo.png" class="img-fluid h-30px" alt="logo" style="display:inline;"></span></button>
                                </div>
                            </div>
                        </div>
                    </div> --}}
                    <div class="col-lg-6 col-md-7 col-sm-8 col-10 mx-auto">
                        <div class="thankyouImg"><img src="{{asset('/public/thankyou.svg')}}" class="w-100" alt=""></div>
                    </div>
                    <div class="col-12">
                        <div class="row">
                            <div class="col-12 fw-bold text-center fs-md-25 fs-sm-18 fs-16 text-muted">Thank you for visiting</div>
                            <div class="col-12 mt-3">
