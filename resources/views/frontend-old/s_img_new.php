...
if(! defined('FILE_CACHE_DIRECTORY') ) 		define ('FILE_CACHE_DIRECTORY', dirname(__FILE__).'/imagecache');				// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
...
if(! defined('MEMORY_LIMIT') ) 	define ('MEMORY_LIMIT', '200M');
if(! defined('DEBUG_ON') ) 	define ('DEBUG_ON', true);
if(! defined('DEBUG_LEVEL') ) 	define ('DEBUG_LEVEL', '4');
...
{
	if(isset($_REQUEST['back_color']))
	define ('DEFAULT_CC', $_REQUEST['back_color']);
	else
	define ('DEFAULT_CC', 'f5f5f5');
...
if(! defined('WEBSHOT_TIMEOUT') ) 	define ('WEBSHOT_TIMEOUT', '200');			//Seconds to wait for a webshot
...
class timthumb {
	...
	protected function debug($level, $msg){
		if(DEBUG_ON && $level <= DEBUG_LEVEL){
            ...
            //echo "TimThumb Debug line " . __LINE__ . " [$execTime : $tick]: $msg";
            //echo "<br/>";
...
/*?image=url&width=200&height=300&zc=0*/