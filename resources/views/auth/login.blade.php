...
<head>
  ...
  <!-- Title -->
  <title>{{ env('APP_NAME') }} | Account - Sign In</title>
  ...
  <link rel="preload" href="{{asset('/public/assets/css/theme.min.css')}}" data-hs-appearance="default" as="style">
  <link rel="preload" href="{{asset('/public/assets/css/theme-dark.min.css')}}" data-hs-appearance="dark" as="style">
...
<body>
  ...
  <main id="content" role="main" class="main">
    <div class="position-fixed top-0 end-0 start-0 bg-img-start" style="height: 32rem; background-image: url({{asset('/public/assets/svg/components/card-6.svg')}});">
      <!-- Shape -->
    ...
    <div class="container py-5 py-sm-7">
      <a class="d-flex justify-content-center mb-5" href="index.html">
        <img class="zi-2" src="{{ asset('/public/settings/'.SettingsTrait::settings('logo')) }}" alt="Image Description" style="width: 8rem;">
      </a>
            ...
            <form method="POST" action="{{ route('login') }}" class="needs-validation" novalidate>
              ...
              <div class="mb-4">
                ...
                {{-- <x-input-error :messages="$errors->get('email')" class="mt-2" style="color:red" /> --}}
                    <div class="invalid-feedback fw-bold fs-11">Please enter your email address.</div>
              </div>
              <!-- End Form -->
              ...
              <div class="mb-4">
                ...
                {{-- <x-input-error :messages="$errors->get('password')" class="mt-2" style="color:red" /> --}}
                    <div class="invalid-feedback fw-bold fs-11">Please enter your password.</div>
              </div>
              <!-- End Form -->
